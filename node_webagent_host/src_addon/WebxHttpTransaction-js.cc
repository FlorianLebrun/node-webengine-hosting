...
void WebxHttpTransactionJS::New(const Nan::FunctionCallbackInfo<v8::Value> &args)
{
  ...
  if (WebxSessionObjectWrap *session = WebxSessionObjectWrap::Unwrap<WebxSessionObjectWrap>(args[0]->ToObject(v8::Isolate::GetCurrent()))) {
    Local<Object> req = args[1]->ToObject(v8::Isolate::GetCurrent());
